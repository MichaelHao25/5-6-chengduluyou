...
$('.h-container .group-header .item .wrap').on('click', function () {
	$('.h-container .group-header .item .wrap').removeClass('active');
	$(this).addClass('active');
})
$('.h-container .group-option .row .item ').on('click', function () {
...
$('.h-container .group-list .group-list-header .sort .item ').on('click', function () {
	if($(this).toggleClass('active').hasClass('active')){
		$(this).find('input').prop('checked',true)
	}else{
		$(this).find('input').prop('checked',false)
...
$('.h-container .group-details-enroll .content .cost span').on('click',function() {
	$(this).addClass('active').siblings().removeClass('active');
})
$('.h-container .group-details-enroll .content .number div .btn').on('click',function() {
	$(this).siblings('.value').text(parseInt($(this).siblings('.value').text())+1);
})
